...
Client.prototype = {
  connect: function(callback) {
    ...
    function fetchOperationsDefs(cb) {
      rest.get(computePath(self._baseURL, "site/automation"), {
...
Operation.prototype.schemas = function(schemas) {
  this._schemas.push.apply(this._schemas, schema);
  return this;
}
...
Operation.prototype.execute = function(options, callback) {
  ...
  var headers = extend({}, this._headers);
  var txTimeout = 5 + (this._timeout / 1000) | 0
  headers["Nuxeo-Transaction-Timeout"] = txTimeout;
  if (this._schemas.length > 0) {
    var schemasHeader = this._schemas.join(",");
    headers["X-NXDocumentProperties"] = schemasHeader;
  }
